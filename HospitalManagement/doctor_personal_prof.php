...
<li><a class="hvr-bounce-to-right "href="editdocprof.php">Edit Profile</a>
...
<div >
  ...
  <div class="product">
	...
	<p class="product_price"><b>Email : </b><?php echo '<span style="color:blue">'. $row['doc_email'] ?></p><br/>
	  ...
	  <p class="product_price"><b>Post : </b><?php echo '<span style="color:blue">'. $row['doctor_post'] ?></p><br/>
	   <p class="product_price"><b>Address : </b><?php echo '<span style="color:blue">'. $row['doctor_address'] ?></p><br/>
	  <p class="product_price"><b>Job : </b><?php echo '<span style="color:blue">'. $row['job_type'] ?></p><br/>
