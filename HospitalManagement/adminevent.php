...
function showUser(str) {
    ...
    if (str == "") {
        document.getElementById("eventajax").innerHTML = "";
        return;
    } else { 
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                document.getElementById("eventajax").innerHTML = xmlhttp.responseText;
            }
        }
        xmlhttp.open("GET","updateevent.php?q="+str,true);
        xmlhttp.send();
    }
}
...
<div class="abbemerbox">
 ...
 <textarea rows="18" cols="70" name="event" id="eventajax" onchange="showUser(this.value)" >
