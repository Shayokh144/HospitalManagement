...
<div class="abbemerbox">
 ...
 <form name="bbform" method="post" action="updatebloodbank.php" > 
<h2>Blood reserved<br>
</h2><br>
A+ : <input type="text" name="ap" value="<?php echo $ap;?>"><br><br>
A- : <input type="text" name="an" value="<?php echo $an;?>"><br><br>
B+ : <input type="text" name="bp" value="<?php echo $bp;?>"><br><br>
B- : <input type="text" name="bn" value="<?php echo $bn;?>"><br><br>

O+ : <input type="text" name="op" value="<?php echo $op;?>"><br><br>
O- : <input type="text" name="on" value="<?php echo $on;?>"><br><br>
AB+ : <input type="text" name="abp" value="<?php echo $abp;?>"><br><br>
AB- : <input type="text" name="abn" value="<?php echo $abn;?>"><br><br>
