...
<div id="main">
<div id="login">
<h2>Login Form for Doctor</h2>
<form name="myForm" action="doctorloginprocess.php" method="post" onsubmit="return validateForm()">
<br>
